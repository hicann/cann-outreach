...
static ge::graphStatus TilingFunc(gert::TilingContext* context)
{
    ...
    auto* tilingData = reinterpret_cast<TanhCustomTilingData*>(context->GetRawTilingData()->GetData());
    tilingData->totalLength = tiling.totalLength;
    tilingData->tileNum = tiling.tileNum;
