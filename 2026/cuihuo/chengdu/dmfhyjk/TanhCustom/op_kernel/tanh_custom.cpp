...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Sub(tmp2, tmp0, tmp1, this->tileLength);                   // tmp2 = e^x - e^(-x)
        AscendC::Add(tmp1, tmp0, tmp1, this->tileLength);                   // tmp1 = e^x + e^(-x)
        AscendC::Div(yLocal, tmp2, tmp1, this->tileLength);                 // y = tanh(x)
