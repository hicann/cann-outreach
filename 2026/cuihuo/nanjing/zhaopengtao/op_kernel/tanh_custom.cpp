...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Muls(tmp0, tmp0, static_cast<float>(2.0), this->tileLength);
        AscendC::Exp(tmp1, tmp0, this->tileLength);
        AscendC::Adds(tmp2, tmp1, static_cast<float>(-1.0), this->tileLength);
        AscendC::Adds(tmp1, tmp1, static_cast<float>(1.0), this->tileLength);
