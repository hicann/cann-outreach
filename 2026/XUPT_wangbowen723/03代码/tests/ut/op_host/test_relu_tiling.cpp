...
// 期望值与 op_host/relu_tiling.cpp 中 ReluTilingFunc 的计算逻辑保持一致：
//   输入 shape (45, 2048)，float32，Ascend910B：totalNum=92160，blockFactor=1440，ubFactor=1440
//   expectTilingKey:   float32 对应 tiling_key 中 RELU_TPL_SCH_MODE_1
...
static ReluTestParam testCases[] = {
    {"relu_0", {45, 2048}, ge::DT_FLOAT, ge::FORMAT_ND, {45, 2048}, ge::DT_FLOAT, ge::FORMAT_ND, "Ascend910B", ge::GRAPH_SUCCESS, 1UL, "92160 1440 1440 ", {0}, 64, 262144, 4096},
};
