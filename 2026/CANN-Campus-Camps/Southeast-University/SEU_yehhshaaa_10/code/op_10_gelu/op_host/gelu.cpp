...
static ge::graphStatus TilingFunc(gert::TilingContext *context) {
    ...
    // Fewer, larger blocks avoid paying the Erf setup cost on very short
    // per-core inputs, which is faster on the competition's 910B runtime.
    const uint32_t usefulCores = (length + 4095) / 4096;
