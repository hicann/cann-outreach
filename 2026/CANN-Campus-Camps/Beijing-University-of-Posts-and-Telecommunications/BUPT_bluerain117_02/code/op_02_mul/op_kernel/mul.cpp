...
public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, uint32_t totalLength, uint32_t tileNum) {
        this->blockLength = totalLength / AscendC::GetBlockNum(); // 每个核处理的元素个数
        this->tileNum = tileNum;
        this->tileLength = this->blockLength / tileNum / BUFFER_NUM; // 每块元素个数
