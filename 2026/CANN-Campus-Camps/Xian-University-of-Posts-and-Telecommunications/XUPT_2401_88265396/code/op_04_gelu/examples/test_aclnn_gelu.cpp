...
int main()
{
    ...
    // 调用 aclnnGeluGetWorkspaceSize 第一段接口
    uint64_t workspaceSize = 0;
    aclOpExecutor* executor = nullptr;
    ret = aclnnGeluGetWorkspaceSize(input_x, output, &workspaceSize, &executor);
    CHECK_RET(ret == 0, LOG_PRINT("aclnnGeluGetWorkspaceSize failed. ERROR: %d\n", ret); return ret);
    ...
    CHECK_RET(ret == 0, LOG_PRINT("aclnnGelu failed. ERROR: %d\n", ret); return ret);
