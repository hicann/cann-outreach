...
#
# 支持 FP16，覆盖三个目标 4D Shape:
#   [1,1,1,128], [1,4,32,64], [8,16,32,32]
#
# 用法：
...
echo "=== 精度验证 ==="
python3 ../scripts/verify_result.py output/output_1_1_1_128.bin output/golden_1_1_1_128.bin \
    || die "精度验证失败 [1_1_1_128]"
python3 ../scripts/verify_result.py output/output_1_4_32_64.bin output/golden_1_4_32_64.bin \
    || die "精度验证失败 [1_4_32_64]"
python3 ../scripts/verify_result.py output/output_8_16_32_32.bin output/golden_8_16_32_32.bin \
    || die "精度验证失败 [8_16_32_32]"
