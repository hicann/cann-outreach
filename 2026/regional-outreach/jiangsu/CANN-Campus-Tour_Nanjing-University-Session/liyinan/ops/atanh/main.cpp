/**
 * @file main.cpp
 * Host launcher for atanh_custom (CPU / NPU).
 */
#include "data_utils.h"
#ifndef ASCENDC_CPU_DEBUG
#include "acl/acl.h"
extern void atanh_custom_do(uint32_t blockDim, void *stream, uint8_t *x, uint8_t *y);
#else
...
int32_t main(int32_t argc, char *argv[])
{
    ...
    ICPU_RUN_KF(atanh_custom, blockDim, x, y);
    ...
    atanh_custom_do(blockDim, stream, xDevice, yDevice);
