...
/*!
 * \file relu_example_tiling_key.h
 * \brief ReluExample TilingKey 定义
 *
 * 一元算子模板参数：
 *   - D_T_X: 数据类型 (C_DT_FLOAT16)
 *   - BUFFER_MODE: 缓冲模式，0=单缓冲, 1=双缓冲
 */

#ifndef __RELU_EXAMPLE_TILING_KEY_H__
#define __RELU_EXAMPLE_TILING_KEY_H__

#include "ascendc/host_api/tiling/template_argument.h"

ASCENDC_TPL_ARGS_DECL(ReluExample,
