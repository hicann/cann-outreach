 ...
 * \brief ReluExample Tiling 实现（arch35：ascend950）
 */
...
#include "../../op_kernel/arch35/relu_example_tiling_data.h"
#include "../../op_kernel/arch35/relu_example_tiling_key.h"
...
constexpr int64_t SINGLE_BUF_TENSOR_COUNT = 2;
