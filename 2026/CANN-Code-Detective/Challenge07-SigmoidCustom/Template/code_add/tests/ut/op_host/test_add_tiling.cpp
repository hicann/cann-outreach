...
//   tilingData = {totalLength=16384, tileNum=16}，workspace = {0}
//   raw tiling 数据按 int64 序列化：16384 | (16 << 32) = 68719493120
//   expectTilingKey：模板 tilingKey 从 0 开始编号，DT_X=float 对应第 0 个 SEL 实例 → 0
static AddTestParam testCases[] = {
    {"add_0", {8, 2048}, ge::DT_FLOAT, ge::FORMAT_ND, {8, 2048}, ge::DT_FLOAT, ge::FORMAT_ND, {8, 2048}, ge::DT_FLOAT, ge::FORMAT_ND, "Ascend910B", ge::GRAPH_SUCCESS, 0UL, "68719493120 ", {0}, 64, 262144, 4096},
};
