...
echo "========================================"
DATA_DIR="${SCRIPT_DIR}/op_kernel/sigmoid_data"
cd "${DATA_DIR}"
python3 gen_data.py

# 运行 Kernel UT
cd "${BUILD_DIR}/op_kernel"
if ./sigmoid_op_kernel_ut; then
