...
int main()
{
    ...
    // 调用 aclnnTanhGetWorkspaceSize 第一段接口
    uint64_t workspaceSize = 0;
    aclOpExecutor* executor = nullptr;
    ret = aclnnTanhGetWorkspaceSize(x, y, &workspaceSize, &executor);
    CHECK_RET(ret == 0, LOG_PRINT("aclnnTanhGetWorkspaceSize failed. ERROR: %d\n", ret); return ret);
    ...
    CHECK_RET(ret == 0, LOG_PRINT("aclnnTanh failed. ERROR: %d\n", ret); return ret);
