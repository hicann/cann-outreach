...
// Double buffering allows MTE2/MTE3 data movement to overlap with vector Add.
// For the fixed [45, 20480] float input, each core owns 23040 elements and each
// local tensor contains 5760 elements (23040 bytes).  The six queue buffers use
// 138240 bytes of UB in total, which fits on Ascend 910B.
