...
int main(int argc, char **argv)
{
    ...
    auto destroyCurrentResources = [&](void *workspaceAddr) {
        DestroyResources({inputX, inputY, outputZ},
                         {inputXDeviceAddr, inputYDeviceAddr, outputZDeviceAddr},
    ...
    CHECK_RET(ret == ACL_SUCCESS, destroyCurrentResources(nullptr); return FAILED);
    ...
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnSubCustomTemplateGetWorkspaceSize failed. ERROR: %d\n", ret);
              destroyCurrentResources(nullptr); return FAILED);
