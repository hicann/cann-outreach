/*!
 * \file test_truncate_div.cpp
 * \brief TruncateDiv 算子 kernel UT 测试
 * 
...
class TruncateDivKernelTest : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        cout << "TruncateDivKernelTest SetUp" << endl;
    }
    static void TearDownTestCase()
    {
        cout << "TruncateDivKernelTest TearDown" << endl;
    }
};

TEST_F(TruncateDivKernelTest, test_kernel_run)
{
    constexpr size_t size = 5;
    constexpr size_t tilingDataSize = sizeof(TruncateDivTilingData);
    ...
    ICPU_RUN_KF((truncate_div<0>), numBlocks, x1, x2, y, workspace, tiling);
    ...
    { std::ofstream _ofs("float16_output_truncate_div_0.bin", std::ios::binary); _ofs.write(reinterpret_cast<const char*>(yHost.data()), yByteSize); }
