...
public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, uint32_t totalLength)
    {
        ...
        blockLength = baseLength + (blockIdx < remainder ? 1U : 0U);
        blockOffset = blockIdx * baseLength + (blockIdx < remainder ? blockIdx : remainder);
        ...
        pipe.InitBuffer(inQueueX, BUFFER_NUM, blockLength * sizeof(DTYPE_X));
        pipe.InitBuffer(inQueueY, BUFFER_NUM, blockLength * sizeof(DTYPE_Y));
        pipe.InitBuffer(outQueueZ, BUFFER_NUM, blockLength * sizeof(DTYPE_Z));
    }
...
private:
    __aicore__ inline void CopyIn()
    {
        ...
        DataCopy(yLocal, yGm[0], blockLength);
    ...
    __aicore__ inline void CopyOut()
    {
        ...
        DataCopy(zGm[0], zLocal, blockLength);
