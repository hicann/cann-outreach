...
int main(int argc, char **argv)
{
    ...
    CHECK_RET(ret == ACL_SUCCESS,
              DestroyResources({inputX, inputY, outputZ},
                               {inputXDeviceAddr, inputYDeviceAddr, outputZDeviceAddr}, stream, deviceId);
              return FAILED);
    ...
    DestroyResources({inputX, inputY, outputZ}, {inputXDeviceAddr, inputYDeviceAddr, outputZDeviceAddr}, stream,
