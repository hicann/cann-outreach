...
static ge::graphStatus TilingFunc(gert::TilingContext* context)
{
  ...
  // 921600 elements are divided evenly among all 40 vector cores. Two tiles
  // per buffer produce four large, aligned transfers per core instead of the
  // original 360 tiny transfers, substantially reducing scheduling overhead.
