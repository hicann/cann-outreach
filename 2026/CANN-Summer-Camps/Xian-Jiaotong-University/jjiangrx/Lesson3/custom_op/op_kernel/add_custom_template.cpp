...
// Double buffering overlaps GM data movement with vector computation.
// For the fixed [45, 20480] float input, each of the 40 cores handles
// 23040 elements. With tileNum = 2, every local tensor contains 5760
// elements (23040 bytes), so all six queue buffers consume 138240 bytes.
