...
private:
    __aicore__ inline void CopyIn(int32_t progress)
    {
        ...
        AscendC::DataCopy(xLocal, xGm[(uint64_t)progress * this->tileLength], this->tileLength);
        AscendC::DataCopy(yLocal, yGm[(uint64_t)progress * this->tileLength], this->tileLength);
