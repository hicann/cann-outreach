...
static TruncateModTestParam testCases[] = {
    {"truncate_mod_0", {5}, ge::DT_FLOAT16, ge::FORMAT_ND, {5}, ge::DT_FLOAT16, ge::FORMAT_ND, {5}, ge::DT_FLOAT16, ge::FORMAT_ND, "Ascend910B", ge::GRAPH_SUCCESS, 0UL, "5 5 43680 ", {0}, 64, 262144, 4096},
};
