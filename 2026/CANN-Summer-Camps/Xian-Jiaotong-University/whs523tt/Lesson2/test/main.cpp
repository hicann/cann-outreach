...
int main(int argc, char **argv)
{
    ...
    CHECK_RET(ret == ACL_SUCCESS,
            DestroyResources(std::vector<void *>{inputX, inputY, outputZ},
                            std::vector<void *>{inputXDeviceAddr, inputYDeviceAddr, outputZDeviceAddr},
                            stream, deviceId);
            return FAILED);
    ...
    // Initialize resource vectors after aclTensor and device memory have been created
