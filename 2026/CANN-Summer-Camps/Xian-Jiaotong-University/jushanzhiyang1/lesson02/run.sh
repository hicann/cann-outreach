...
export LD_LIBRARY_PATH=${ASCEND_TOOLKIT_HOME}/opp/vendors/customize/op_api/lib:$LD_LIBRARY_PATH
...
g++ -I$ASCEND_TOOLKIT_HOME/include \
    -I${ASCEND_TOOLKIT_HOME}/opp/vendors/customize/op_api/include \
    -L$ASCEND_TOOLKIT_HOME/lib64 \
    -L${ASCEND_TOOLKIT_HOME}/opp/vendors/customize/op_api/lib \
    test/main.cpp \
