...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Muls(tmpTensor0, xLocal, static_cast<DTYPE_X>(-1.0), this->tileLength);
        AscendC::Exp(tmpTensor1, xLocal, this->tileLength);
        AscendC::Exp(tmpTensor2, tmpTensor0, this->tileLength);
        AscendC::Sub(yLocal, tmpTensor1, tmpTensor2, this->tileLength);
        AscendC::Add(tmpTensor0, tmpTensor1, tmpTensor2, this->tileLength);
        AscendC::Div(yLocal, yLocal, tmpTensor0, this->tileLength);
