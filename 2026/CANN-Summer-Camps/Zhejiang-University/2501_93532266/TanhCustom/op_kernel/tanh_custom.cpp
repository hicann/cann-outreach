...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Add(yLocal, expX, expNegX, this->tileLength);
        AscendC::Div(yLocal, numerator, yLocal, this->tileLength);
