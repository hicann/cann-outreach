...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Muls(expNegative, xLocal, static_cast<DTYPE_X>(-1.0f), this->tileLength);
        AscendC::Exp(expNegative, expNegative, this->tileLength);
        AscendC::Sub(numerator, expPositive, expNegative, this->tileLength);
        AscendC::Add(expPositive, expPositive, expNegative, this->tileLength);
        AscendC::Div(yLocal, numerator, expPositive, this->tileLength);
