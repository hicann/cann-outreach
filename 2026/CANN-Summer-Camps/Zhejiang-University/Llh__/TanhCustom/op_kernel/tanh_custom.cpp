...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Exp(tmp0, xLocal, tileLength);
        AscendC::Muls(tmp1, xLocal, static_cast<DTYPE_X>(-1.0), tileLength);
        AscendC::Exp(tmp1, tmp1, tileLength);
        AscendC::Sub(tmp2, tmp0, tmp1, tileLength);
        AscendC::Add(tmp0, tmp0, tmp1, tileLength);
        AscendC::Div(yLocal, tmp2, tmp0, tileLength);
