...
namespace optiling {
constexpr uint32_t BLOCK_DIM = 8U;
...
static ge::graphStatus TilingFunc(gert::TilingContext* context)
{
    ...
    const uint32_t totalLength = static_cast<uint32_t>(storageShape.GetShapeSize());

    TanhCustomTilingData tilingData;
    tilingData.set_totalLength(totalLength);
    tilingData.set_tileNum(TILE_NUM);
