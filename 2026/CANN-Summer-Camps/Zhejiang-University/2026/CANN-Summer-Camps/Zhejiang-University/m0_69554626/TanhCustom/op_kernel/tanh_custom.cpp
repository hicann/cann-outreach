...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Muls(expNegX, xLocal, static_cast<DTYPE_X>(-1.0), tileLength);
        AscendC::Exp(expNegX, expNegX, tileLength);
        AscendC::Sub(numerator, expX, expNegX, tileLength);
        AscendC::Add(expX, expX, expNegX, tileLength);
