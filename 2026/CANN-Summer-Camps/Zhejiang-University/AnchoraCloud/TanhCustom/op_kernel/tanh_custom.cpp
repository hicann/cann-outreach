...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Exp(tmpLocal0, xLocal, this->tileLength);
        AscendC::Muls(tmpLocal1, xLocal, (half)-1.0, this->tileLength);
        AscendC::Exp(tmpLocal1, tmpLocal1, this->tileLength);
        AscendC::Sub(tmpLocal2, tmpLocal0, tmpLocal1, this->tileLength);
        AscendC::Add(tmpLocal0, tmpLocal0, tmpLocal1, this->tileLength);
        AscendC::Div(yLocal, tmpLocal2, tmpLocal0, this->tileLength);
