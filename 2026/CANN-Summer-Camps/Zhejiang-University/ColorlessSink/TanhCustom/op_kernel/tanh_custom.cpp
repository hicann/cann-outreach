...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Muls(work, xLocal, static_cast<DTYPE_X>(-1), this->tileLength);
        ...
        AscendC::Add(work, expX, expNegX, this->tileLength);
        AscendC::Div(yLocal, yLocal, work, this->tileLength);
