...
static ge::graphStatus TilingFunc(gert::TilingContext* context)
{
    ...
    if (tilingData->GetCapacity() < sizeof(TanhCustomTilingData)) {
        return ge::GRAPH_FAILED;
    }
    memcpy(tilingData->GetData(), &tiling, sizeof(TanhCustomTilingData));
    tilingData->SetDataSize(sizeof(TanhCustomTilingData));
