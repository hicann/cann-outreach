...
static ge::graphStatus TilingFunc(gert::TilingContext* context)
{
    ...
    void* buf = context->GetRawTilingData()->GetData();
    size_t cap = context->GetRawTilingData()->GetCapacity();
    if (cap >= sizeof(TanhCustomTilingData)) {
    memcpy(buf, &tiling, sizeof(TanhCustomTilingData));
