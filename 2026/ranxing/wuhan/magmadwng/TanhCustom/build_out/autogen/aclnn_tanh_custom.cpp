...
#include "TanhCustom_op_resource.h"
...
#ifdef ACLNN_WITH_BINARY
    static uint32_t TanhCustomOpTypeId = op::GenOpTypeId("TanhCustom", TanhCustom_RESOURCES);
#endif
...
#ifdef ACLNN_WITH_BINARY
    NnopbaseAddOpTypeId(*executor, TanhCustomOpTypeId);
#endif
